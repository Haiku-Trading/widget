...
interface YearnFinanceIconProps extends React.SVGProps<SVGSVGElement> {
  width?: string | number;
  height?: string | number;
  size?: string | number; // Convenience prop for square icons
}

export const YearnFinanceIcon: React.FC<YearnFinanceIconProps> = ({
  width,
  height,
  size,
  ...props
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="100%"
        >
          <stop offset="0%" stop-color="#FB245A"></stop>
          <stop offset="100%" stop-color="#0657F9"></stop>
        </linearGradient>
      </defs>
      <circle cx="16" cy="16" r="16" fill="url(#yearn-gradient)"></circle>
      <path
        fill-rule="evenodd"
        clipRule="evenodd"
