...
// Import from dist bundle (built by Rollup) - this matches production
// Note: HaikuWidget must come from dist to test production CSS processing
import { HaikuWidget } from "../dist/index.esm.js";
// Types and constants can come from source since they don't affect CSS processing
import type { WidgetConfig, WidgetTheme } from "./index";
                    ...
                    <div className="min-h-screen bg-gray-50 p-4">
                        <div className="max-w-7xl mx-auto">
                            ...
                            <div className="text-center mb-6">
                                <h1 className="text-3xl font-bold text-gray-900 mb-2">Haiku Swap Widget Playground (Dist Build)</h1>
                                <p className="text-lg text-gray-600 mb-2">Testing widget from built dist folder - matches production</p>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div className="lg:col-span-2 space-y-6">
                                    <div className="bg-white rounded-lg p-6 shadow-sm border">
                                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Live Widget Preview (Dist Build)</h3>
